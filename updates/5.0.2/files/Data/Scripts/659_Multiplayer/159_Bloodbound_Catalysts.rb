...
#===============================================================================
# Item Registration (dynamic, after GameData loads)
#===============================================================================
if defined?(GameData) && defined?(GameData::Item)
  class GameData::Item
    class << self
      alias bloodbound_original_load load
      def load
        bloodbound_original_load

        base_id_number = 9100  # Start after SHOOTINGSTARCHARM (9001)
        ...
        if defined?(MultiplayerDebug)
          MultiplayerDebug.info("BLOODBOUND", "Registered #{BloodboundCatalysts::CATALYSTS.length} Bloodbound Catalysts (id #{base_id_number}-#{base_id_number + BloodboundCatalysts::CATALYSTS.length - 1})")
        end
      end
    end
  end
...
if defined?(MultiplayerDebug)
  ...
  MultiplayerDebug.info("BLOODBOUND", "159_Bloodbound_Catalysts.rb loaded")
  MultiplayerDebug.info("BLOODBOUND", "18 Bloodbound Catalyst items registered")
