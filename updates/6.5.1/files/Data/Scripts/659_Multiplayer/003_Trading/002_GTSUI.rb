  ...
  class Scene_GTS
    ...
    def draw_type_icon(bmp, type_sym, x, y)
      ...
      begin
        ...
        dst_rect = Rect.new(x, y, TYPE_DRAW_W, TYPE_DRAW_H)
        bmp.stretch_blt(dst_rect, @typebitmap.bitmap, src_rect)
      rescue; end
    end
    ...
    def draw_detail_pokemon(b, entry)
      ...
      begin
        ...
        scale = (Settings::FRONTSPRITE_SCALE rescue 0.6667)
    ...
    def action_list_item
      ...
      qty = GTSUI.pbChooseNumber(_INTL("Quantity (max {1})", max_q), max_q, 1)
      return if !qty || qty <= 0
