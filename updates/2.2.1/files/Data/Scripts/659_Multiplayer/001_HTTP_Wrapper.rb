...
module HTTPWrapper
  ...
  # Download file from URL with SHA256 verification
  # @param url [String] URL to download from
  # @param local_path [String] Local file path to save to
  # @param expected_sha256 [String, nil] Expected SHA256 hash (optional)
  # @return [Boolean] True if successful, false otherwise
  def http_download_file(url, local_path, expected_sha256 = nil)
    init_wininet
    ...
    begin
      ...
      if expected_sha256
        ...
        if actual_sha256 != expected_sha256
          MultiplayerDebug.error("HTTP-WRAPPER", "SHA256 mismatch for #{url}") if defined?(MultiplayerDebug)
  ...
  # @return [String] SHA256 hash in hexadecimal
